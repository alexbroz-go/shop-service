...
const (
	...
	UserCartOrderService_CheckUserExists_FullMethodName = "/usercartorder.UserCartOrderService/CheckUserExists"
)
...
type UserCartOrderServiceClient interface {
	...
	CheckUserExists(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*CheckUserExistsResponse, error)
}
...
func (c *userCartOrderServiceClient) CheckUserExists(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*CheckUserExistsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckUserExistsResponse)
	err := c.cc.Invoke(ctx, UserCartOrderService_CheckUserExists_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserCartOrderServiceServer interface {
	...
	CheckUserExists(context.Context, *UserRequest) (*CheckUserExistsResponse, error)
...
func (UnimplementedUserCartOrderServiceServer) CheckUserExists(context.Context, *UserRequest) (*CheckUserExistsResponse, error) {
...
func _UserCartOrderService_CheckUserExists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserCartOrderServiceServer).CheckUserExists(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserCartOrderService_CheckUserExists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserCartOrderServiceServer).CheckUserExists(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserCartOrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserCartOrderService_CheckUserExists_Handler,
		},
	},
